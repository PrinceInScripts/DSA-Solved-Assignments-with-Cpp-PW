...
ç NumArray(int[] nums) Initializes the object with the integer array nums .Ó
ç int sumRange(int left, int right) Returns the sum of the elements of nums between
